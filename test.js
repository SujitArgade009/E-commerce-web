...
const brands = [...new Set([...products.map((e) => e.brand)])]; // Here we map the categories from the array using map and then use set for the unique catrgories.

const sujit = brands.map((c) => ({
  value: c,
  label: c.split('-').join(' '),
  checked: false,
}));
